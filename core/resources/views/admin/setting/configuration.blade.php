                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                ...
                                <p class="mb-0">
                                    <small>@lang('If you enable referral system, users can refer anyone and get percentage amount in each plan purchased per configuration.')@if (gs('referral_system'))
                                            <a href="{{ route('admin.setting.general') }}">@lang('Configure referral system')</a>
                                        @endif
                                    </small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input name="referral_system" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('referral_system')) checked @endif>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="form-group">
                                <input name="auto_approval" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('auto_approval')) checked @endif>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="form-group">
                                <input name="is_invoice_active" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('is_invoice_active')) checked @endif>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="form-group">
                                <input name="watermark" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('watermark')) checked @endif>
                            </div>
                        </li>
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                ...
                                <p class="mb-0">
                                    <small>@lang('If you enable the advertisement system, the website will display the advertisements you have set up from the ') <a href="{{ route('admin.ads.all') }}">@lang('Ads menu.')</a></small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input name="ads_module" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('ads_module')) checked @endif>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="form-group">
                                <input name="contact_system" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('contact_system')) checked @endif>
                            </div>
                        </li>
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                ...
                                <p class="mb-0">
                                    <small>@lang('Donation module will be activated if you enable the Donation Module. You must configure') <a href="{{route('admin.donation.setting.index')}}">@lang('donation configuration')</a> @lang('to recieve donations.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input name="donation_module" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs('donation_module')) checked @endif>
                            </div>
                        </li>
