...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['total']) }}" title="Total Images" style="7" type="2" link="{{ route('admin.images.all') }}" icon="las la-images" color="white" bg="15" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['pending']) }}" title="Pending Images" style="7" type="2" link="{{ route('admin.images.pending') }}" icon="las la-spinner" color="white" bg="warning" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['approved']) }}" title="Approved Images" style="7" type="2" link="{{ route('admin.images.approved') }}" icon="las la-check" color="white" bg="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['rejected']) }}" title="Rejected Images" style="7" type="2" link="{{ route('admin.images.rejected') }}" icon="las la-times" color="white" bg="red" />
        </div>
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['plan_purchased']) }}" title="Plan Purchased" style="7" link="{{ route('admin.report.plan.purchased') }}" icon="las la-list-ol" color="white" bg="dark" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['total_downloads']) }}" title="Total Downloads" style="7" link="{{ route('admin.report.download.log') }}" icon="las la-cloud-download-alt" color="white" bg="11" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ showAmount($resources['total_contributor_earnings']) }}" title="Contributor's Earning" style="7" link="{{ route('admin.report.contributor.earnings') }}" icon="las la-money-bill-wave-alt" color="white" bg="3" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ shortNumber($resources['total_collections']) }}" title="Total Collections" style="7" link="{{ route('admin.report.user.image.collections') }}" icon="las la-folder-plus" color="white" bg="1" />
        </div>
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ showAmount($donations['total_donations_amount']) }}" title="Total Donation" style="6" outline="true" link="{{ route('admin.donation.log') }}" icon="las la-dollar-sign" color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ showAmount($donations['total_donations_paid']) }}" title="Paid Donations" style="6" outline="true" link="{{ route('admin.donation.paid') }}" icon="las la-check-circle" color="warning" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ showAmount($donations['total_donations_pending']) }}" title="Pending Donations" style="6" outline="true" link="{{ route('admin.donation.pending') }}" icon="las la-spinner" color="warning" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ showAmount($donations['total_donations_rejected']) }}" title="Rejected Donations" style="6" outline="true" link="{{ route('admin.donation.reject') }}" icon="las la-times-circle" color="danger" />
        </div>
