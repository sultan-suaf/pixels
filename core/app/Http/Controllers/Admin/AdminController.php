...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $donations['total_donations_amount']   = Donation::paid()->sum('amount');
        $donations['total_donations_pending']  = Donation::pending()->count();
        $donations['total_donations_paid']     = Donation::paid()->count();
        $donations['total_donations_rejected'] = Donation::rejected()->count();
        ...
        $resources['plan_purchased']             = PlanPurchase::count();

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart','deposit','withdrawals','resources','donations'));
    }
